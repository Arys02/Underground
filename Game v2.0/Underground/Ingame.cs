...
namespace Underground
{
    ...
    static class Ingame
    {
        ...
        public static void recup_env()
        {
            ...
            //string path3 = @"Ressources\Game\Squellette2\Squellettebonnetaille.obj";
            ...
            {
                if (cases[i].type == 3)
                    Program.getModel(@"Ressources\Game\LevelTex\Tournant(L).obj", Matrix.RotationY((float)Math.PI / 2 * (cases[i].rot - 1))
                                     * Matrix.Translation(
                    ...
                    Program.getModel(@"Ressources\Game\LevelTex\Croissement(T).obj", Matrix.RotationY((float)Math.PI / 2 * (cases[i].rot - 1 + 1))
                                     * Matrix.Translation(
                                        -(2 * rayon_salles) * cases[i].x,
                                        0,
                                        -(2 * rayon_salles) * cases[i].y),
                    ...
                    Program.getModel(@"Ressources\Game\LevelTex\CuldeSac.obj", Matrix.RotationY((float)Math.PI / 2 * (cases[i].rot - 1 + 1))
                                     * Matrix.Translation(
                                        -(2 * rayon_salles) * cases[i].x,
                                        0,
                                        -(2 * rayon_salles) * cases[i].y),
                    ...
                    Program.getModel(@"Ressources\Game\LevelTex\Alledroite.obj", Matrix.RotationY((float)Math.PI / 2 * (cases[i].rot - 1 + 2))
                                     * Matrix.Translation(
                                        -(2 * rayon_salles) * cases[i].x,
                                        0,
                                        -(2 * rayon_salles) * cases[i].y),
                    ...
                    Program.getModel(@"Ressources\Game\LevelTex\Croissement(+).obj", Matrix.RotationY((float)Math.PI / 2 * (cases[i].rot - 1))
                                     * Matrix.Translation(
                                        -(2 * rayon_salles) * cases[i].x,
                                        0,
                                        -(2 * rayon_salles) * cases[i].y),
